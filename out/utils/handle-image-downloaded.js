...
exports.handleImageDownloaded = void 0;
const vscode_1 = require("vscode");
const format_image_link_1 = require("./format-image-link");
const handleImageDownloaded = async (imageLink) => {
    ...
    if (textEditor && textEditor.document.languageId === 'markdown') {
        ...
        const selected = await vscode_1.window.showInformationMessage('Image downloaded', {
            modal: true,
            detail: imageLink,
        }, ...copyOptions);
        let textToCopy = '';
...
exports.handleImageDownloaded = handleImageDownloaded;
//# sourceMappingURL=handle-image-downloaded.js.map